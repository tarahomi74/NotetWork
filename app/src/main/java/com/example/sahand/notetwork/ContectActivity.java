...
public class ContectActivity extends AppCompatActivity {
    EditText name,phon,email,new_pas,user_name,family;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_login_new.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(context,"نام خانوادگی را وارد کنید",Toast.LENGTH_SHORT).show();
                }
                else if(user_name.getText().toString().equals(""))
                {
                    Toast.makeText(context,"نام کابری را تعیین کنید",Toast.LENGTH_SHORT).show();
                }
